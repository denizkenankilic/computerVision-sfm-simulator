...
%PN1=RTMatrix(aci1,T1)*ConvHomogen(PN);  p1=ProjectionF(PN1)';
%PN2=RTMatrix(aci2,T2)*ConvHomogen(PN1); p2=ProjectionF(PN2)';
%PN3=RTMatrix(aci3,T3)*ConvHomogen(PN2); p3=ProjectionF(PN3)';
%PN4=RTMatrix(aci4,T4)*ConvHomogen(PN3); p4=ProjectionF(PN4)';
%R2=RotationMat(aci2);
%R3=RotationMat(aci3);
%R4=RotationMat(aci4);
